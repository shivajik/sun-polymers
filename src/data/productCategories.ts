...
export const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    shortName: "Telecom",
    icon: Phone,
    description: "Specialized plastic components for telecommunication equipment and infrastructure.",
  ...
  },
  {
    ...
    shortName: "Other",
    icon: MoreHorizontal,
    description: "Custom plastic solutions for specialized and niche industry requirements.",
  ...
  },
  {
    ...
    icon: Pencil,
    description: "Quality plastic products for office and school stationery applications.",
